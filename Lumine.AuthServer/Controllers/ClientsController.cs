...
namespace Lumine.AuthServer.Controllers
{
    ...
    public class ClientsController : ControllerBase
    {
        ...
        public async Task<ActionResult<PagedResultDto<OidcClientDto>>> GetAll([FromQuery] string? keyword, [FromQuery] int pageIndex = 1, [FromQuery] int pageSize = 20, CancellationToken cancellationToken = default)
        {
