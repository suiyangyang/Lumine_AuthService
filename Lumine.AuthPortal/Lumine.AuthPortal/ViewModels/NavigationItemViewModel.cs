...
public static class NavigationIconData
{
    private static readonly Dictionary<string, StreamGeometry> Icons = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["eye"] = Parse("M12 6.5C7 6.5 2.73 9.61 1 12C2.73 14.39 7 17.5 12 17.5S21.27 14.39 23 12C21.27 9.61 17 6.5 12 6.5ZM12 15.5C10.07 15.5 8.5 13.93 8.5 12S10.07 8.5 12 8.5S15.5 10.07 15.5 12S13.93 15.5 12 15.5ZM12 10C10.9 10 10 10.9 10 12S10.9 14 12 14S14 13.1 14 12S13.1 10 12 10Z"),
